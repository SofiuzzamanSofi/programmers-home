...
const SignInUp = () => {
    ...
    const { error, setErro, createNewUser, signInLogIn, signInPopUp, updatePro, emailVeryfy } = useContext(AuthContext);
        ...
        <div className='min-h-screen  pt-[5%] 2xl:py-[8%]'>
            <div className="text-center m-auto p-4 w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        location.pathname === "/signin" ?
                            ...
                            <>
                                ...
                                <div>
                                    ...
                                    <input type="url" name="photo" id="photo" placeholder="//https://example.com/etc" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                </div>
                            </>
                    }
                    <div>
                ...
                <div className="flex justify-center space-x-4 ">
                    <button onClick={() => handlePopUpGoogle(googleProvider)} aria-label="Log in with Google" className="p-3 rounded-sm hover:text-yellow-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                            <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
                        </svg>
                    </button>
                    <button onClick={() => handlePopUpGoogle(facebookProvider)} aria-label="Log in with Twitter" className="p-3 rounded-sm hover:text-yellow-300">
                    ...
                    <button onClick={() => handlePopUpGoogle(githubProvider)} aria-label="Log in with GitHub" className="p-3 rounded-sm hover:text-yellow-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
